      ...
      <div>
        ...
        <div className="flex flex-wrap gap-1">
          ...
          <a
            ...
            className="group flex items-center gap-1 px-3 py-2 rounded-md font-mono text-xs text-slate-400 hover:text-neon-green transition-all duration-200"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-1 px-3 py-2 rounded-md font-mono text-xs text-slate-400 hover:text-cyan-400 transition-all duration-200"
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
          >
            <LinkedInIcon />
            <span>LinkedIn</span>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-1 px-3 py-2 rounded-md font-mono text-xs text-slate-400 hover:text-sky-400 transition-all duration-200"
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
          >
            <FacebookIcon />
            <span>Facebook</span>
          ...
          <a
            ...
            className="group flex items-center gap-1 px-3 py-2 rounded-md font-mono text-xs text-slate-400 hover:text-pink-400 transition-all duration-200"
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
          >
            <EmailIcon />
